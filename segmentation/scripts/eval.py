...
class Evaluator(object):
    ...
    def eval(self, no_metric=False):
        ...
        for i, (image, target, filename) in tqdm(enumerate(self.val_loader)):
...
if __name__ == '__main__':
    ...
    if args.distributed:
        ...
        synchronize()
    print(f"Evaluation running on {args.device}")
    outdir = Path(args.save_path) #/ f'{args.model}_{args.backbone}_{args.dataset}'
    ...
    evaluator.eval(no_metric=args.no_metric)
