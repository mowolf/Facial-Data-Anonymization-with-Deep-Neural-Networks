...
class Pix2PixVggWeightedL1Model(Pix2PixModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--vgg_scaling', default=2.5, help='weight for vgg loss for each block')
    ...
    def backward_G(self):
        ...
        # loss
        self.loss_G_L1 = self.criterionL1(scale * self.fake_B, scale * self.real_B) * self.opt.lambda_L1
